...
from .views import (
    ...
    do_you_have_sleeping_problem, acknowledge_page, terms, contactus, Subscription, calculator, redirect_logo
)
...
urlpatterns = [
    ...
    path('redirect_logo/', redirect_logo, name='redirect_logo'),
