...
urlpatterns = [
    ...
    # path('diary/<int:wday>/', diary_view_get, name='diary_view_get'),
    # path('api/diary/<int:wday>/<int:pid>/', diary_view_post, name='diary_view_post'),
    ...
    path('api/providerhandbooks/', providerhandbooks_view, name='providerhandbooks-api'),
